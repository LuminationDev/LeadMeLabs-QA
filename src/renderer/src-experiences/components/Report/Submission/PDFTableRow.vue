...
import PDFDeviceStatus from "./PDFDeviceStatus.vue";
...
<template>
  ...
  <tr class="h-12 bg-gray-100 border border-gray-200">
    <td colspan="3" class="pl-8 text-xs">
      <div class="flex flex-row items-center">
        ...
        <div v-for="(device, index) in experienceStore.orderedDevices" :key="index" class="flex flex-row items-center">
  ...
  <tr class="bg-gray-50 text-xs" v-for="(device, index) in experienceStore.orderedDevices" :key="index">
