...
import ExperienceChecks from "../../components/IMVR/ExperienceChecks.vue";
import ExperienceLibrary from "../../components/IMVR/ExperienceLibrary.vue";
...
onMounted(() => {
  ...
  if (experienceStore.experienceChecks.length === 0) {
    experienceStore.buildExperienceChecks()
  }
...
<template>
  <GenericLayout>
      ...
      <div class="flex flex-col">
        <div class="flex flex-row justify-between">
          ...
          <div class="flex flex-row border-gray-100 border-2 rounded-2xl p-4 items-center">
            ...
            <template v-for="station in experienceStore.stations" :id="station.id">
    ...
    <template v-slot:content>
      <ExperienceLibrary v-if="route.name === 'experiences-imvr-pre_experience_checks'" />
      <ExperienceChecks v-else-if="route.name === 'experiences-imvr-experience_checks'" />
    </template>
  </GenericLayout>
</template>
