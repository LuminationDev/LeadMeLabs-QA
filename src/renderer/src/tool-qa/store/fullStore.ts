...
export const useFullStore = defineStore({
    ...
    actions: {
        ...
        buildQaList() {
            ...
            networkChecks.checks.push(defaultGateway, dnsServer, altDnsServer, staticIpAddress, allowedThroughFirewall, launcherAllowedThroughFirewall, nucCanAccessNucHosting, stationCanAccessStationHosting, canAccessLauncherHosting, canReachPlayStore, canReachAnalytics, canReachSentry, canReachSteamStatic, packetLossTest, milesightNotDefaultPassword)
            ...
            windowsChecks.checks.push(taskScheduler, oldTaskScheduler, cbusScriptId, environmentLabLocation, environmentSteamUsername, environmentSteamPassword, environmentNucAddress, environmentStationId, environmentEncryptionKey, environmentHeadsetType, environmentRoom, environmentStationMode, environmentCbusIp, environmentCbusLogin, environmentNucScriptId, environmentNovastarLogin, allSceneAppliancesValid);
