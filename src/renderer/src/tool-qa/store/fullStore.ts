...
export const useFullStore = defineStore({
    ...
    actions: {
        ...
        buildQaList() {
            ...
            windowsChecks.checks.push(taskScheduler, oldTaskScheduler, cbusScriptId, environmentLabLocation, environmentSteamUsername, environmentSteamPassword, environmentUserDirectory, environmentNucAddress, environmentStationId, environmentEncryptionKey, environmentHeadsetType, environmentRoom, environmentStationMode, environmentCbusIp, environmentCbusLogin, environmentNucScriptId, environmentNovastarLogin, allSceneAppliancesValid);
