...
<template>
  <div
    ...
    :class="{
      ...
      'bg-red-50 border-red-400': checking === 'error' || checking === 'error_cbus',
  ...
  >
    <div>
      <div class="flex flex-col p-2">
        ...
        <img v-else-if="checking === 'error' || checking === 'error_cbus'" src="../../../assets/icons/checking-error.svg" :alt="`${checking} icon`" />
    ...
    <div v-if="callback !== undefined && checking !== 'testing'" @click="callback"
